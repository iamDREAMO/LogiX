...
LogiX is a desktop application designed for student record management. Built with Python's Tkinter framework and SQLite3 database, it provides a graphical interface to manage student academic records such as subject-wise performance metrics.
