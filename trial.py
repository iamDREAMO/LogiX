...
def bginsertion(ntb):
    ...
    def mydatainsertion():
        ...
        my_cursor.execute(“insert into insvalues('”+m.get()+”','”+n.get()+”','”+o.get()+”','”+p.get()+”','”+q.get()+”')”)
        mydb.commit()
        mydb.close()
...
def mysearch(ntb):
    ...
    def searched():
        ...
        for loop in r:
            ...
            myl11.place(x=200,y=100,width=300)myl12 = Label(myf6, text = “”, font =
            ('Calibri',15), bg = 'LightBlue', fg = 'Red')
...
myl2.place(x=350,y=200)myl1 = Label(myf7, text = “Maths : “, font =
('Calibri',15), bg = 'LightBlue', fg = 'Red')
myl1.place(x=200,y=250)
myl2 = Entry(myf7, font = ('Calibri',15), bg =
...
('Calibri',15), bg = 'LightBlue', fg = 'Red')
myl16.place(x=350,y=200,width=300)myl17 = Label(myf7, text = “”, font =
('Calibri',15), bg = 'LightBlue', fg = 'Red')
myl17.place(x=200,y=250,width=300)
...
= s1)
mye1.place(x = 200, y = 50, width = 100)def mydeletion():
db = sqlite3.connect('mydemo.db')
cr = db.cursor()
...
'LightBlue', fg = 'Red')
myl1.place(x=200,y=100)mye1 = Entry(myf2, font = ('Calibri',15), textvariable
= d)
...
mybtn.place(x=250,y=200, width = 100,height = 30)mybtn1 = Button(myf2, text = 'Home', font =
...
mye2 = Entry(myf2, font = ('Calibri',15), textvariable
= b)
mye2.place(x = 300, y =150, width = 100, height = 20)myl3 = Label(myf2, text = 'Enter CN: ', bg =
'LightBlue', fg = 'Red')
...
mybtn1 = Button(myf2, text = 'Home', font =
('Calibri',15), command = myhome)
mybtn1.place(x=20,y=350, width = 100,height = 30)
mybtn2 = Button(myf2, text = 'Login', font =
('Calibri',15), command = mylogin)mybtn2.place(x=480,y=350, width = 120,height = 30)
def myhome():
...
myb2 = Button(myf1, text = 'Register', command =
myregis)
