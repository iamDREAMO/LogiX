...
def create_insert_tab(ntb):
    ...
    # Labels and Entries
    Label(f4, font=('Cambria', 12), text='Enter Roll No.', bg="#F0F8FF", fg="#9F00FF").place(x=150, y=50)
    Entry(f4, font=('Cambria', 12), textvariable=roll_no).place(x=300, y=50, width=100)
    
    Label(f4, font=('Cambria', 12), text='Enter Name', bg="#F0F8FF", fg="#9F00FF").place(x=150, y=100)
    Entry(f4, font=('Cambria', 12), textvariable=name).place(x=300, y=100, width=100)
    
    Label(f4, font=('Cambria', 12), text='Enter Phy.', bg="#F0F8FF", fg="#9F00FF").place(x=150, y=150)
    Entry(f4, font=('Cambria', 12), textvariable=phy).place(x=300, y=150, width=100)
    
    Label(f4, font=('Cambria', 12), text='Enter Chem.', bg="#F0F8FF", fg="#9F00FF").place(x=150, y=200)
    Entry(f4, font=('Cambria', 12), textvariable=chem).place(x=300, y=200, width=100)
    
    Label(f4, font=('Cambria', 12), text='Enter Maths.', bg="#F0F8FF", fg="#9F00FF").place(x=150, y=250)
